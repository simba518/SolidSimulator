/********************************************************************************
** Form generated from reading UI file 'set_elastic_mtl.ui'
**
** Created: Thu Apr 3 16:14:54 2014
**      by: Qt User Interface Compiler version 4.8.1
**
** WARNING! All changes made in this file will be lost when recompiling UI file!
********************************************************************************/

#ifndef UI_SET_ELASTIC_MTL_H
#define UI_SET_ELASTIC_MTL_H
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menuSelectType = new QMenu(menu_File);
        menuSelectType->setObjectName(QString::fromUtf8("menuSelectType"));
        ...
        menu_File->addAction(actionLoadConNodes);
        menu_File->addAction(actionSaveMaterial);
        menu_File->addAction(actionSaveMaterialAsHinp);
        menu_File->addAction(actionLoadMaterial);
        menu_File->addAction(actionFixSelectedTets);
        menu_File->addAction(actionPrintSelected);
        menu_File->addAction(actionSaveRecordZ);
        menu_File->addAction(actionSaveEigenValues);
        menu_File->addAction(actionSaveEigenVectors);
        menu_File->addAction(menuSelectType->menuAction());
        menu_File->addAction(actionExit);
        menuSelectType->addAction(actionSelectNodes);
        menuSelectType->addAction(actionSelectTets);
        menuView->addAction(actionVolMesh);
        menuView->addAction(actionObjMesh);
        menuView->addAction(actionTetGroups);
        menuView->addAction(actionConNodes);
        menuView->addAction(actionMaterialGroups);
        ...
        menuSimulation->addAction(actionRecord);
        menuSimulation->addAction(actionClearRecordedZ);
        menuSimulation->addAction(actionInterpolateMaterials);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        menuSelectType->setTitle(QApplication::translate("MainWindow", "SelectType", 0, QApplication::UnicodeUTF8));
